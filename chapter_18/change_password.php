...
<form action="change_password.php" method="post">
	<fieldset>
		<p><strong>New Password:</strong> <input type="password" name="password1" size="20" maxlength="20"> <small>Use only letters, numbers, and the underscore character. Must be between 4 and 20 characters long.</small></p>
		<p><strong>Confirm Password:</strong> <input type="password" name="password2" size="20" maxlength="20"></p>
	</fieldset>
