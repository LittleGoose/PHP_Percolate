...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if($uid) { # If everything's OK
		...
		if(mysqli_affected_rows($dbc) == 1) { # If it ran OK
			...
			# Send an email
			$body = "Your password to log into jesseevers.com has been temporarily changed to '$p'. Please log in using this password and this email address. Then you may change your password to something more familiar.";
			mail($_POST['email'], 'Your temporary password.', $body, 'From: admin@jessevers.com');
