...
require('../../mysqli_connect4.php'); # Connect to the database
...
if(mysqli_affected_rows($dbc) == 1) {
	...
	# Close this preapred statement
	mysqli_stmt_close($stmt);

	# Report on the success
	if($affected == count($_SESSION['cart'])) { # Whoohoo!
		...
		echo '<p>Thank you for your order. You will be notified when the item(s) ship.</p>';
		...
		# Send the order information to the admin
	}
} else { # Rollback and report the problem
	...
	# Send the order information to the system admin
}
