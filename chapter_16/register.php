<?php 
# Script 16.2 - register.php
# Made on 3/3/14
# Made by Jesse Evers

// This scripti performs an INSERT query to add a record to the users table
// This is an OOP version of the script from Chapter 9

$page_title = 'Register';
# Tells the .php file to include .html file as the header
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) { # If everything was submitted and correct:
		...
		if ($mysqli->affected_rows == 1) { # If it ran ok...
			...
			<p>You are now registered. In Chagper 12 you will actually be able to log in!</p><p>
			<br></p>";
