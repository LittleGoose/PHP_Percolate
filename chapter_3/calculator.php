...
<form action="calculator.php" method="post">
	...
	<p>
		Ave. Price Per Gallon: <span class="input"><input type="radio" name="gallon_price" value="3.00">3.00</span>
		Ave. Price Per Gallon: <span class="input"><input type="radio" name="gallon_price" value="3.50">3.50</span>
		Ave. Price Per Gallon: <span class="input"><input type="radio" name="gallon_price" value="4.00">4.00</span>
	</p>
	<p>Fuel Efficiency: 
